namespace Customer.Models
{
	public static class RepositoryHelper
	{
		...
		public static VW客戶檢視表Repository GetVW客戶檢視表Repository()
		{
			var repository = new VW客戶檢視表Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static VW客戶檢視表Repository GetVW客戶檢視表Repository(IUnitOfWork unitOfWork)
		{
			var repository = new VW客戶檢視表Repository();
			repository.UnitOfWork = unitOfWork;
			return repository;
